...
import static com.example.readcomment.utils.ReflectionUtil.get;
    ...
    public static String setParam(Object object) {
        ...
        try {
            for (Field field : fields) {
                if (get(object, field) != null) {
                    queryString.append(field.getName()).append("=").append(get(object, field)).append("&");
                }
            }
